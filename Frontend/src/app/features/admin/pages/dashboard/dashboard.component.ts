...
@Component({
  ...
  template: `
    <div>
      <h1 class="text-3xl font-black uppercase tracking-tight text-gray-900 mb-8">Dashboard</h1>
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
          ...
          <dt class="text-sm font-bold text-gray-500 uppercase tracking-wide">Total Revenue</dt>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
          ...
          <dt class="text-sm font-bold text-gray-500 uppercase tracking-wide">Total Tickets Sold</dt>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
           <div class="flex items-center justify-between mb-4">
             ...
             <span class="text-xs font-bold uppercase tracking-wider text-gray-500 bg-gray-50 px-2 py-1 rounded-md">Stable</span>
          </div>
          <dt class="text-sm font-bold text-gray-500 uppercase tracking-wide">Active Events</dt>
